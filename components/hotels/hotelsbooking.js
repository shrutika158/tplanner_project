...
function Hotelsbooking() {
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		try {
			const url ="http://localhost:3000/users/hotelbooking";
    ...
    <div className="App">
      <div class="form">
        <div class="form-text">
            ...
            <p>BOOK YOUR LAVISH HOTEL NOW !</p>
        </div>
        ...
        <div className='imgback'>
            <img src="https://cyrusrecharge.com/img/services/hotel.jpg"></img>
        </div>
        </div>
